    ...
    description: (
        <div className="space-y-8">
            <div className="flex flex-col gap-2">
                <h3 className="text-white">Optimization & Refactor</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-6 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 hover:border-primary/40 transition-all">
                    <div className="flex gap-2">
                        ...
                        <h4 className="font-bold text-white mb-2 uppercase tracking-wide">Refactoring</h4>
                    </div>
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 hover:border-primary/40 transition-all">
                    <div className="flex gap-2">
                        <i className="text-white fas fa-code-branch text-2xl"></i>
                        <h4 className="font-bold text-white mb-2 uppercase tracking-wide">Optimization</h4>
                    </div>
